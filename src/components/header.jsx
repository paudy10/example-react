...
const Header = () => {
    ...
    return (
        <div className='header' >
            <span className='title'><Navbar role={role} className='menu' title='فروشگاه گیاهان دارویی' /> <Link to='/' className='nolinkdecoration header-title blacktext' >اَپلیکیشن ساز</Link> </span>
